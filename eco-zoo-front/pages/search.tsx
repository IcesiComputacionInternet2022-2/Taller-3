...
export default function Search() {
    ...
    const handleSearch = async () => {
        ...
        if (res.status === 200) {
            ...
            modal.message = capybaraRes.message;
            modal.title = "Something went wrong | Error Code: " + capybaraRes.code
            let newModal = {...modal}
            setModal(newModal)
            // @ts-ignore
                ...
                <div className="form-control">
                    ...
                    <div className="flex justify-center space-x-2">
                        <div className="input-group justify-center w-fit">
                            <span>Search by: </span>
                            <select onChange={() => setSearchByID(!searchByID)}
                                    className="select select-bordered self-center">
