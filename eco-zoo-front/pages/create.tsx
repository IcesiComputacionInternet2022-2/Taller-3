...
export default function Create() {
    ...
    const handleOnSubmit = async (event: any) => {
        ...
        if (res.status === 200) {
            modal.message = "Capybara successfully created!";
            modal.title = "Success"
            let newModal = {...modal}
            setModal(newModal)
            // @ts-ignore
            ...
            modal.title = "Something went wrong | Error Code: " + error.code
            let newModal = {...modal}
            setModal(newModal)
            // @ts-ignore
            modalRef.current.click()
    ...
    return (
        <>
            <div className="hero min-h-screen pb-16 bg-base-200">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    <div className="text-center lg:text-left lg:mx-8">
                        ...
                        <Image
                            src="https://animals.sandiegozoo.org/sites/default/files/2016-10/animals_hero_capybara.jpg"
                        ...
                        <div className="card-body">
                            <form onSubmit={handleOnSubmit}>
                                <div className="form-control">
                                    <label className="label">
                                        <span className="label-text"><span
                                            className="text-red-500 align-middle">*</span> Name</span>
                                    </label>
                                ...
                                <div className="form-control">
                                    <label className="label">
                                        <span className="label-text"><span
                                            className="text-red-500 align-middle">*</span> Sex</span>
                                    </label>
                                ...
                                <div className="form-control">
                                    <label className="label">
                                        <span className="label-text"><span
                                            className="text-red-500 align-middle">*</span> Age</span>
                                    </label>
                                    <label className="input-group">
                                ...
                                <div className="form-control">
                                    <label className="label">
                                        <span className="label-text"><span
                                            className="text-red-500 align-middle">*</span> Height</span>
                                    </label>
                                    <label className="input-group">
                                ...
                                <div className="form-control">
                                    <label className="label">
                                        <span className="label-text"><span
                                            className="text-red-500 align-middle">*</span> Weight</span>
                                    </label>
                                    <label className="input-group">
                                ...
                                <div className="form-control">
                                    <label className="label">
                                        <span className="label-text"><span
                                            className="text-red-500 align-middle">*</span> Arrival date</span>
                                    </label>
                                    <label className="input-group">
            ...
            <Modal modal={modal} modalRef={modalRef}/>
        </>
    )
}
