...
public class OstrichRestControllerTests {
    ...
    private OstrichRestController ostrichRestController;
    ...
    public void init(){
        ...
        ostrichRestController = new OstrichRestController(ostrichMapper, ostrichService);
    }
    ...
    public void testGetOstrichById() {
        ...
        OstrichDTO ostrichResult = ostrichRestController.getOstrichById(baseOstrich.getId());
    ...
    public void testGetOstrichByName() {
        ...
        List<OstrichDTO> ostrichResult = ostrichRestController.getOstrichByName(baseOstrich.getName());
    ...
    public void testGetOstriches() {
        ...
        List<OstrichDTO> ostrichResult = ostrichRestController.getOstriches();
    ...
    public void testCreateOstrich() {
        ...
        OstrichDTO ostrichResult = ostrichRestController.createOstrich(baseOstrich);
    ...
    public void testCreateOstrichWithInvalidNameLength() {
        ...
        try {
            ostrichRestController.createOstrich(baseOstrich);
            fail();
